...
STRATEGY_GRAMMAR_PROMPT = (
    ...
    '    Use as a reversal SIGNAL: "candlestick engulfing > 0" = bullish engulfing this bar (a long entry\n'
    '    trigger, esp. combined with a trend filter); "< 0" = bearish (an exit/short trigger).\n'
    '\n'
